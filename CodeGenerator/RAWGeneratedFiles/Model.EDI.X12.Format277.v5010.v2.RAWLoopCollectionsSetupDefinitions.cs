...
SegmentQualifierValues = new List<SegmentQualifiers>(){ new SegmentQualifiers(1,"X")},
RequiredFileds = new List<int>() {  1,2,3,4,5,6,7,8  },
...
OwningLoopCollection = this,
SegmentDefinitionName = "Empty",
SegmentQualifierValues = new List<SegmentQualifiers>(){ new SegmentQualifiers(1,"277")},
...
OwningLoopCollection = this,
SegmentDefinitionName = "Empty",
SegmentQualifierValues = new List<SegmentQualifiers>(){ new SegmentQualifiers(1,"0010")},
RequiredFileds = new List<int>() {  1,2,3,4,5,6  },
Usage = SegmentUsageType.Optional
});
}
}
